...
class CustomersController extends Controller
{
    ...
    public function destroy(Customer $customer)
    {
        ...
        return redirect()->route('customers.index')->withMessage('Customer / orders and contact deleted successfully');
    }

    public function customerTrash(){
        
       $customers = Customer::orderBy('created_at','asc')->where('delete',1)->Paginate(10);
        return view('trash_can.customer' , compact('customers'));
    }

    public function delete(Customer $delete){
        $delete->elimination();
